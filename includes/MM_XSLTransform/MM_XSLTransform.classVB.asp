...
' Start error messages definition
	...
	errorMessages("MM_MISSING_OBJECT") = "Required object (""%s"") from Microsoft XML Core Services (MSXML) is not installed.<br>Download and install the latest version from http://msdn.microsoft.com/xml before continuing."
	errorMessages("MM_INVALID_PATH") = """%s"" is not a valid path.<br>Error message was: %s"
	errorMessages("MM_XML_LOADING_ERROR") = "An error occured while loading XML document ""%s"".<br>Error message was: %s"
	errorMessages("MM_XSL_LOADING_ERROR") = "An error occured while loading XSLT document ""%s"".<br>Error message was: %s"
	errorMessages("MM_INVALID_XML_ERROR") = """%s"" is not a valid XML document.<br>"
	errorMessages("MM_INVALID_XSL_ERROR") = """%s"" is not a valid XSLT document.<br>"
	errorMessages("MM_LOADING_FAILED_DETAILS") = "reason: %s<br>error code: %s<br>file position: %s<br>line: %s<br>character position: %s<br>"
	...
	errorMessages("MM_OPEN_FILE_ERROR") = "The specified file %s could not be found.<br>"
